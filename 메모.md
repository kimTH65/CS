...
#    2, 1, 9, 5   
    ...
    x_dup = x2//N - x1//N-1  => x 중간구간이 존재  2
    y_dup = y2//N - y1//N-1  => y 중간구간이 존재  1
    
    
	<x_dup,y_dup 가 -1 아닐때>>
    
1    (x1%N - N , y1%N  - N) *1                2     (0 - N , y1%N  - N) * x_dup       3    (0 - x2%N+1 , y1%N - N) *1 




4    (x1%N - N , 0 - N) * y_dup              5     (0 - N , 0 - N) * x_dup * y_dup   6    (0 - x2%N+1 , 0 - N) * y_dup
   



7    (x1%N - N , 0 - y2%N +1) *1              8     (0 - N , 0 - y2%N +1) * x_dup     9    (0 - x2%N+1 , 0 - y2%N_+1) *1 


	<x_dup 가 -1 >
	
1    (x1%N - x2%N+1 , y1%N  - N) *1  
...
7    (x1%N - x2%N+1 , 0 - y2%N +1) *1


	<y_dup 가 -1 >
	
1    (x1%N - N , y1%N - y2%N+1) *1                2     (0 - N , y2%N+1 - N)                 3    (0 - x2%N+1 , y2%N+1 - N) *1 



	<x,y_dup 가 -1 >
	
1    (x1%N - x2%N+1 , y1%N - y2%N+1) *1          
